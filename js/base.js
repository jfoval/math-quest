...
const DEFAULT_POS = { flag: [10, 1], pad: [6, 7], solar: [0, 9], antenna: [1, 1], garden: [0, 4], dome: [4, 1], tanks: [9, 4], rover: [3, 10], crystals: [7.5, 11], telescope: [7, 0], dish: [0, 0], lights: [1, 11], pet: [3, 5], tower: [10, 6], rocket: [6.5, 7.5], me: [11, 7] };
